...
# (str) Package name
package.name = zwerfbondappv2

# (str) Package domain (needed for android/ios packaging)
package.domain = org.ernestapp

# (str) Source code where the main.py live
source.dir = .

# (list) Source files to include (leave empty to include all the files)
source.include_exts = py,png,jpg,kv,atlas,ttf,mbtiles
...
requirements = python3,kivy,pillow,plyer,requests,urllib3,chardet,idna,certifi,sqlite3,android,openssl,futures
